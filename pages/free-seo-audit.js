        ...
        <Main>
          <section className="contact">
            <div className="container">
              ...
              <p>
                This Free Mini SEO Audit can answer these questions for you.
              </p>
              <p>
                While this is not a{' '}
                <Link href="/seo-audit">
              ...
              <p>
                The truth is, you may never find out what's stopping your
                website from performing in the search engines unless you perform
                an SEO Audit.
              </p>
              <p>
              ...
              <ul>
                ...
                <li>
                  <b>
                    Keywords 3 of your competitors rank for, and you are not.
                  </b>
                </li>
                <li>
                  <b>
              ...
              <p>
                This Free audit will help you discover what you need to fix to
                get your website ranking higher and in front of more customers.
              </p>
              <h3>
              ...
              <ul>
                <li>
                  <b>
                    ...
                    what we found and the opportunities to rank higher, reach
                ...
                <li>
                  <b>
                    Your{' '}
                    <span class="thick">total organic monthly traffic.</span>
                  </b>
                </li>
                <li>
                ...
                <li>
                  <b>
                    <span class="thick">10 Keywords</span> you should rank for
                    to get more leads, customers, and make more money.
                  </b>
                </li>
                <li>
                  <b>
                    On-Page SEO issues affecting your website website
                    performance.
                  </b>
                </li>
                <li>
                ...
                <li>
                  <b>
                    Technical SEO issues affecting your website performance.
                  </b>
                </li>
                <li>
                  <b>
